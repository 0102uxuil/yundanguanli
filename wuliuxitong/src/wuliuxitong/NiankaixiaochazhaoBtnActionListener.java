...
public class NiankaixiaochazhaoBtnActionListener implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		String sql;
		sql = "select chepaihao, DATE_FORMAT(riqi ,'%Y') , shenche, shenchebz, baoxian, baoxianbz, gerenxian, gerenxianbz, shenyingyunzheng, gprs, qitafeiyong, beizhu, zongkaixiao from niankaixiaodan where "
				+ "riqi >= " + "'" 
...
//			}
			...
			rec_vector.addElement(rs.getString("shenchebz"));
			rec_vector.addElement(rs.getString("baoxian"));
			rec_vector.addElement(rs.getString("baoxianbz"));
			rec_vector.addElement(rs.getString("gerenxian"));
			rec_vector.addElement(rs.getString("gerenxianbz"));
