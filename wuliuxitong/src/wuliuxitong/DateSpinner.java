...
public class DateSpinner extends JPanel {
	...
	public String getYear(){
		return this.year.getValue().toString().trim();
	}
	
	public String getMonth(){
		return this.month.getValue().toString().trim();
	}
	
	public String getDate(){
		return this.year.getValue().toString().trim() + "-" + this.month.getValue().toString().trim() + "-" +"01";
	}
