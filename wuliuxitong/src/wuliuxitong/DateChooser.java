...
public class DateChooser extends JPanel {
	...
	private DateChooserButton btnChoose = new DateChooserButton("▼"); // /u25BC是指：▼下拉箭头的unicode码
...
//				String tmp = FileTool.getContentWithTime("e:/test.txt",
//						DateChooser.this.getText());
//				String jtf = "0";
//				String hsf = "0";
//				if (tmp != null) {
//					String[] contents = tmp.split(",");
//					jtf = contents[1].split("=")[1];
//					hsf = contents[2].split("=")[1];
//					System.out.println(contents);
//				}
//				((JTextField) ((JPanel) owner.getComponent(1)).getComponent(1))
//						.setText(jtf);
//				((JTextField) ((JPanel) owner.getComponent(2)).getComponent(1))
//						.setText(hsf);
